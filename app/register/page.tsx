...
export default function RegisterPage() {
  return (
    <div className="min-h-screen bg-black text-[#F4F1DE] flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="absolute bottom-1/4 right-1/2 translate-x-1/2 w-96 h-96 bg-[#E07A5F]/20 rounded-full blur-[120px] pointer-events-none" />
      ...
      >
        <div className="text-center mb-8 space-y-2">
          ...
          <p className="text-xs text-white/60">
            Bergabunglah untuk mendapatkan layanan terbaik bagi kendaraan Anda.
          </p>
        </div>
